...
public class Game {
        ...
        if (p1.hasTreasure(t)){
            if (treasure instanceof Food){
               Food ateFood = (Food)treasure;
                int foodHealth = ateFood.getHealthAdded();
                p1.setHealth(playerHealth + foodHealth);  
                playerInventory.remove(treasure);
    ...
    public static void main(String[] args){
        ...
        //guigui.appendToDescription("_________________________________________________________________________________________________");
        //guigui.appendToDescription("There are 4 floors to the Tower and you start on the first floor. You are attacked by an enemy when you enter a new floor."); 
        //guigui.appendToDescription("Player Action Inputs are always two words and case sensitive. To play the game, enter any of the following as Player Action Input:"); 
        //guigui.appendToDescription("'check Stats' displays your overall stats"); 
        //guigui.appendToDescription("'check Health' displays your health stats' and 'check Armour' displays your armour stats"); 
        //guigui.appendToDescription("'go Up' moves you up a floor and 'go Down' moves you down a floor");
        //guigui.appendToDescription("'take' followed by 'the name of the item' (case sensitive) puts the item into your inventory");
        //guigui.appendToDescription("'eat' followed by 'the name of the food item' (case sensitive) allows you to eat the food item and gain the corresponding health");
        //guigui.appendToDescription("'q' quits the game");
